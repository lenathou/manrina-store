    ...
    return (
        <div className="flex items-center">
            <button
                onClick={decrement}
                disabled={disabled}
                className="bg-[#F48953] px-2 py-2 min-w-[20px] flex items-center justify-center rounded-tl-lg rounded-bl-lg disabled:opacity-50 hover:bg-[#e67a4a] transition-colors"
            >
                <Minus
                    height={20}
                    width={20}
            ...
            <button
                onClick={increment}
                disabled={disabled}
                className="bg-[#F48953] px-2 py-2 min-w-[20px] flex items-center justify-center rounded-tr-lg rounded-br-lg disabled:opacity-50 hover:bg-[#e67a4a] transition-colors"
            >
                <Plus
                    height={20}
                    width={20}
